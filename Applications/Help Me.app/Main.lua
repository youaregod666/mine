...
layout:addChild(GUI.text(1, 1, 0x4B4B4B, "Hello " .. system.getUser() ..  " Do you need Help. Go to MineOS Wiki For Info"))

-- Customize MineOS menu for this application by your will
local contextMenu = menu:addContextMenuItem("Help me")
